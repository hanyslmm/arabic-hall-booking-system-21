-- ==========================================
-- COMPLETE AUTH SYSTEM REBUILD MIGRATION
-- ==========================================
...
-- ==========================================
-- The system now has:
-- 1. Clean slate - all old users and policies removed
-- 2. Simple, non-recursive authorization system
-- 3. Two admin users: admin@local.app (owner) and marwa@local.app (manager)
-- 4. JWT-based role checking to avoid RLS recursion
-- 5. Clear separation between admin and regular user permissions